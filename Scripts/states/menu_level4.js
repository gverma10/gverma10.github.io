...
(function (states) {
    ...
    var Menu_level4 = (function () {
        ...
        function Menu_level4() {
            ...
            this.mailPilotLabel1 = new objects.Label(280, 170, "Superman is getting face to face\n\nwith the person behind the airplane\n\ncrash and its no other than 'Lex',\n\ndefeat him and clear the clouds\n\nof evil from Metropolis.");
            ...
            this.mailPilotLabel2 = new objects.Label(450, 415, "Level - IV\n\n'Lex Luhor'");
            ...
            this.mailPilotLabel3 = new objects.Label(425, 465, "GAME WIN at 160 points");
